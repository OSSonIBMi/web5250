...
public class Servlet5250 extends HttpServlet implements TN5250jConstants {
 ...
 //  private SessionManager manager;
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      if (httpSession.isNew()
         ...
         if (!session.isConnected()) {
            ...
            // ouput a response with a header to check back with us in 3 seconds
            response.setHeader("Refresh", "3");
            out.println("<html>");
            out.println("<head><title>Connecting</title></head>");
            out.println("<style type=" + '"' + "text/css" + '"' + ">");
            out
                  .println(".textbox {background: transparent; border-top-width: 0px;border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}</style>");
            out.println("<body>");
      ...
      if (session.isConnected()) {
         ...
         // output the CSS inline commands
         //  we should probably move this out into it's own .css file later and
         //  do not know which is faster inline or external.
         setStyles(out);
         ...
         out.println("<body OnLoad=" + onLoad
               + "bgcolor=black text=#00FF00 style=font-family:courier; " +
               ">");

         // Change the method to "get" if we need to see the parameters that are
         // being passed.
         out.println("<form name=\"DS5250\" action=\"Servlet5250 \" method=\"get\">");
   ...
   private void setStyles(PrintWriter out) {

         String fontFamily = "courier new, courier, mono; font-size: 15px; ";
         String fontFamily2 = ".boxfont {font-family:courier new, courier, mono; font-size: 15px;} ";
         out.println("<style type=text/css >");

         // text box styles.
         out.println(".textbox32 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox33 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox34 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox35 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox36 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
//         out.println(".textbox36 {class=\"boxfont " +
//                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox37 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox38 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox39 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox40 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox41 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox42 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox43 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox44 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox45 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox46 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox47 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox48 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox49 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox50 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox51 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox52 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox53 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox54 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox55 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox56 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox57 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox58 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox59 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox60 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox61 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox62 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");
         out.println(".textbox63 {font-family: " + fontFamily +
                     " background: transparent; border-top-width: 0px;	border-right-width: 0px; border-bottom-width: thin; border-left-width: 0px; border-top-style: none; border-right-style: none; border-bottom-style: solid; border-left-style: none; border-bottom-color: #00CC33; color: #00CC33;}");

         // color styles.
//         out.println(".black {color: black;}");
//         out.println(".green {color: #00FF00;}");
//         out.println(".green-ul {color: #00FF00;text-decoration: underline}");
//         out.println(".green-rv {background-color: #00FF00;color: black;}");
//         out.println(".green-rv-ul {background-color: #00FF00;color: black;text-decoration: underline;}");
//         out.println(".white {color: white;}");
//         out.println(".white-ul {color: white;text-decoration: underline}");
//         out.println(".white-rv {background-color: white;color: black;}");
//         out.println(".red {color: red;}");
//         out.println(".red-ul {color: red;text-decoration: underline}");
//         out.println(".red-rv {background-color: red;color: black;}");
//         out.println(".red-rv-ul {background-color: red;color: black;text-decoration: underline}");
//         out.println(".blue {color: rgb(140,120,255);}");
//         out.println(".blue-ul {color: rgb(140,120,255);text-decoration: underline}");
//         out.println(".blue-rv {background-color: rgb(140,120,255);color: black;}");
//         out.println(".blue-rv-ul {background-color: rgb(140,120,255);color: black;text-decoration: underline}");
//         out.println(".pink {color: pink;}");
//         out.println(".pink-ul {color: pink;text-decoration: underline}");
//         out.println(".pink-rv {background-color: pink;color: black;}");
//         out.println(".pink-rv-ul {background-color: pink;color: black;text-decoration: underline;}");
//         out.println(".yellow {color: yellow;}");
//         out.println(".yellow-ul {color: yellow;text-decoration: underline}");
//         out.println(".yellow-rv {background-color: yellow;color: black;}");
//         out.println(".turq {color: turquoise;}");
//         out.println(".turq-ul {color: turquoise;text-decoration: underline}");
//         out.println(".turq-cs {color: turquoise;border-left: dashed; border-left-width: 1px;border-right: dashed; border-right-width: 1px}");
//         out.println(".turq-rv {background-color: turquoise;color: black;}");
//         out.println(".turq-rv-ul {background-color: turquoise;color: black;text-decoration: underline;}");
//         out.println(".nondisp {background-color: black;color: black;}");
         out.println("</style>");
